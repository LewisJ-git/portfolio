            ...
            <div className='text-[1.4rem] relative z-[9] font-semibold flex 600:text-[1.2rem]'>
                <ul className='inline-flex flex-1 items-center px-[1.5rem] my-[1.3rem] 600:px-[0px]'>
                    ...
                    <motion.li
                        ...
                        initial='initial'
                        animate='enter'
                        transition={{ delay: 0.1, ...bezier }}
                        className='flex-auto flex-grow-0 flex-shrink-[2] mx-[1.1rem] 600:mx-[0.8rem] relative z-10'
                    >
                        <NavItem title={'Home'} linkURL={'/'} />
                    </motion.li>
                    <li className='flex-auto flex-grow-[2] flex-shrink-0 mx-[1.1rem] 600:mx-[0px] 600:flex-shrink-[2] 600:flex-grow-0 relative z-10'></li>
                    <motion.li
                        variants={fadeUp}
                        initial='initial'
                        animate='enter'
                        ...
                        className='flex-auto flex-grow-0 flex-shrink-[2] mx-[1.1rem] 600:mx-[0.8rem] relative z-10'
                    >
                        <NavItem title={'About'} linkURL={'/about'} />
                    </motion.li>
                    <motion.li
                        variants={fadeUp}
                        initial='initial'
                        animate='enter'
                        transition={{ delay: 0.4, ...bezier }}
                        className='flex-auto flex-grow-0 flex-shrink-[2] mx-[1.1rem] 600:mx-[0.8rem] relative z-10'
                    >
                        <NavItem title={'Résumé'} linkURL={'/resume'} />
                    </motion.li>
                    <motion.li
                        variants={fadeUp}
                        initial='initial'
                        animate='enter'
                        transition={{ delay: 0.5, ...bezier }}
                        className='flex-auto flex-grow-0 flex-shrink-[2] mx-[1.1rem] 600:mx-[0.8rem] relative z-10'
                    >
                        <NavItem title={'Contact'} linkURL={'/contact'} />
                    </motion.li>
                </ul>
            </div>
        </div>
